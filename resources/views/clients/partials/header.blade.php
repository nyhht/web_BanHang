            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="ltn__top-bar-menu">
                        <ul>
                            <li><a href="locations.html"><i class="icon-placeholder"></i>Bình Minh, Hà Nội, Việt Nam</a></li>
                            <li><a href="mailto:nguyenhieu27hsht@gmail.com?Subject=Contact%20with%20to%20you"><i
                                        class="icon-mail"></i> nguyenhieu27hsht@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <nav>
                            <div class="ltn__main-menu">
                                <ul>
                                    ...
                                    @auth
                                        <li><a href="{{ route('subscriptions.index') }}">Gói định kỳ</a></li>
                                    @endauth
                ...
                <div class="ltn__header-options ltn__header-options-2">
                    ...
                    <!-- user-menu -->
                    @include('clients.partials.notification_dropdown')
                    <div class="ltn__drop-menu user-menu">
                        <ul>
                            <li>
                                @if (Auth::check())
                                    <img src="{{ asset('storage/' . ($userClient->avatar ?? 'uploads/users/default-avatar.png') ) }}" alt="Avatar" style="width: 50px; height: 50px;">
                                @else
                                ...
                                <ul>
                                    @if (Auth::check())
                                        ...
                                        <li><a href="{{ route('logout') }}" data-logout-confirm>Đăng xuất</a></li>
                                    @else
